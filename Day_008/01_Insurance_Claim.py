...
accident_type = input("Accident Type = ")

if policy_age >= 2:
    if claim_amount <= 50000:
        if accident_type == "minor":
            print("Claim Status = approve claim")
        else:
            print("Claim Status = approve it with inspection")
    else:
        if claim_amount > 50000 and claim_amount <= 200000:
    ...
    if policy_age < 2:
        if accident_type == "minor":
             ...
             print("Claim Status = pending revies") 
