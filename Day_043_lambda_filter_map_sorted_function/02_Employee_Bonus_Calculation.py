'''
2.Employee Bonus Calculation (Using filter() and map() with Lambda Expressions)
...
res = filter(lambda x: x >= 50000, salaries)
#print(list(res))

up_salaries=map(lambda x: x + ((x*10)/100),res)
print(list(up_salaries))
