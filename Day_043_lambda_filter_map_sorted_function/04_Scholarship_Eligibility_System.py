'''
4Scholarship Eligibility System (Using filter(), map(), and sorted() with Lambda Expressions)
...
res = list(filter(lambda x: x >= 75, marks))
#print(res)

up_marks = sorted(list(map(lambda x: x+5, res)),reverse=True)
print(up_marks)
