'''
08_Lottery Ticket Verification (Count Occurrences Using Recursion)
...
def lucky_num(t,lucky):
   if t == "":
        return 0

   if int(t[0]) == lucky:

       return 1+lucky_num(t[1:],lucky) 

   return lucky_num(t[1:], lucky)
