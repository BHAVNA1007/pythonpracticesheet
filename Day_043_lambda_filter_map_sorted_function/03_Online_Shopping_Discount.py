...
product_price = list(map(int,input("Enter the product prices: ").split(" ")))
#print(product_price)

res = filter(lambda x : x >= 2000 , product_price)
#print(list(res))

discount_price = map(lambda x: x - ((x*20)/100), res)
print("Discounted Prices: ",list(discount_price))
